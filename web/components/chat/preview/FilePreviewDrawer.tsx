...
export default function FilePreviewDrawer({
  ...
  return (
    <div
      ...
      className={`fixed right-0 top-0 z-sheet flex h-full w-[min(560px,92vw)] flex-col border-l border-[var(--border)] bg-[var(--card)] shadow-2xl transition-transform ease-out ${
