...
// lucide-react icons used inline by the chat UI (capability picker, tool
// chips, research-source toggles). The icon-bearing data structures
// themselves live in lib/chat-config.ts.
